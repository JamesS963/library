...
@ContextConfiguration(classes = { BookController.class, UserDetailsService.class, BookService.class,
...
//		MultipartFile cover = new MockMultipartFile("data", "other-file-name.data", "text/plain", "some other type".getBytes());
